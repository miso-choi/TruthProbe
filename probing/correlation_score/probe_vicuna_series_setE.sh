#!/usr/bin/env bash
# probe_vicuna_series_setE.sh
### Vicuna / Mistral / LLaVA series probing — Set E (HaluEval+PHD context, RLHF-V+PHD image) ###
set -euo pipefail
...
MAX_SAMPLES=0
OUT_ROOT="/root/Desktop/workspace/miso/faithful-probing/probing_code/script_camera_ready/correlation_score/outputs/vicuna_cross_dataset_probing_set_e_cv5"
mkdir -p "${OUT_ROOT}"
