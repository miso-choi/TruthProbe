...
MAX_SAMPLES=0
OUT_ROOT="/root/Desktop/workspace/miso/faithful-probing/probing_code/script_camera_ready/correlation_score/outputs/vicuna_cross_dataset_probing_set_a_cv5"
mkdir -p "${OUT_ROOT}"
