#!/usr/bin/env bash
# probe_qwen_series_setD.sh
### Qwen2.5 / Mistral series probing — Set D (HaluEval context + RLHF-V image) ###
set -euo pipefail
...
MAX_SAMPLES=0
OUT_ROOT="/root/Desktop/workspace/miso/faithful-probing/probing_code/script_camera_ready/correlation_score/outputs/qwen_cross_dataset_probing_set_d_cv5"
mkdir -p "${OUT_ROOT}"
