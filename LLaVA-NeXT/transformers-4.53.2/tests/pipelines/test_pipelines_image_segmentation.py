...
class ImageSegmentationPipelineTests(unittest.TestCase):
    ...
    def test_small_model_pt(self):
        ...
        expected_masks = [
            "https://huggingface.co/datasets/hf-internal-testing/mask-REDACTED/blob/main/mask_0.png",
            "https://huggingface.co/datasets/hf-internal-testing/mask-REDACTED/blob/main/mask_1.png",
            "https://huggingface.co/datasets/hf-internal-testing/mask-REDACTED/blob/main/mask_2.png",
        ]
