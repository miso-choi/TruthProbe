...
python3 -m accelerate.commands.launch \
	...
	--batch_size 1 \
	--log_samples \
	--log_samples_suffix llava_v1.6_vicuna_7b_${TASK_ALIAS} \
	--output_path ./logs/ \
	--process_with_media


# TruthProbe_LLM
TASK_ALIAS="pope_aokvqa_truthful_head_truth_llm_norm_0p2"
...
# TruthProbe_MLLM
TASK_ALIAS="pope_aokvqa_truthful_head_truth_mllm_norm_0p1"
TRUTHFUL_HEAD_FILE="/root/Desktop/workspace/miso/faithful-lmms-eval/notebooks/linear_probing_score/converted_score_cv5_head_metrics_llava_next_rlhfv_2726.npy"
AMPLIFY="0.1"
TASK_METADATA_ARGS="gate_truthful_head=true,truthful_head=true,truthful_head_filepath=${TRUTHFUL_HEAD_FILE},hyperparams.normalize_amplifying_factor=${AMPLIFY}"
