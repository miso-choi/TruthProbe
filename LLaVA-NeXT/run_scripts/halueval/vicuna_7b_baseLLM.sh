...
TRUTHFUL_HEAD_FILE="/root/Desktop/workspace/miso/faithful-lmms-eval/notebooks/linear_probing_score/converted_score_cv5_head_metrics_llama2_halueval_292.npy"
AMPLIFY="6.0"
...
python3 -m accelerate.commands.launch \
	...
	--batch_size 1 \
	--log_samples \
	--log_samples_suffix vicuna_7b_baseLLM_${TASK_ALIAS} \
	--output_path ./logs/ \
	--process_with_media
