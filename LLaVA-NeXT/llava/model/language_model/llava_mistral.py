...
class LlavaMistralForCausalLM(MistralForCausalLM, LlavaMetaForCausalLM):
    ...
    def generate(
        ...
        **kwargs,
        ...
        return super().generate(position_ids=position_ids, attention_mask=attention_mask, inputs_embeds=inputs_embeds, gate_truthful_head=gate_truthful_head, truthful_head=truthful_head, hyperparams=hyperparams, **kwargs)
