"""
Custom model wrapper for Qwen3-VL-Thinking to handle faithful evaluation parameters.
"""
...
class Qwen3VLThinkingCustomConfig(Qwen3VLConfig):
    model_type = "qwen3_vl_thinking_llama"


class Qwen3VLThinkingCustomForCausalLM(Qwen3VLForConditionalGeneration):
    config_class = Qwen3VLThinkingCustomConfig
...
AutoConfig.register("qwen3_vl_thinking_llama", Qwen3VLThinkingCustomConfig)
AutoModelForCausalLM.register(Qwen3VLThinkingCustomConfig, Qwen3VLThinkingCustomForCausalLM)
