"""
Custom model wrapper for Llama-2 to handle faithful evaluation parameters.
...
class Llama2CustomConfig(LlamaConfig):
    """Custom config class for Llama-2 model wrapper."""
    model_type = "llama2_llama"

class Llama2CustomForCausalLM(LlamaForCausalLM):
    """Custom model wrapper for Llama-2 that handles faithful evaluation parameters."""
    config_class = Llama2CustomConfig

    def __init__(self, config):
        super().__init__(config)
        config.model_type = "llama2_llama"
...
AutoConfig.register("llama2_llama", Llama2CustomConfig)
AutoModelForCausalLM.register(Llama2CustomConfig, Llama2CustomForCausalLM)
